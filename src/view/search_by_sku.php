    ...
    <div class="spinner"></div>
                        ...
                        $.ajax({
                            ...
                            success: function(resposta) {
                                if (resposta.data) {
                                    ...
                                    divResultado.html(`<div class="alert-error">Erro ao buscar produto</div>`);
                                }
                            },
            ...
            function tableView(json, divResultado) {
                const cost = new Intl.NumberFormat('pt-BR', {
                    style: 'currency',
                    currency: 'BRL'
                }).format(json.data.cost);



                const createdAtFormatada = new Date(json.data.created_at).toLocaleDateString('pt-BR', {
                    day: '2-digit',
                    month: '2-digit',
                    year: 'numeric',
                    hour: '2-digit',
                ...
                const updatedAtFormatada = new Date(json.data.updated_at).toLocaleDateString('pt-BR', {
                    day: '2-digit',
                    month: '2-digit',
                    year: 'numeric',
                    hour: '2-digit',
                ...
                const stockUpdatedAtFormatada = new Date(json.data.stock_updated_at).toLocaleDateString('pt-BR', {
                    day: '2-digit',
                    month: '2-digit',
                    year: 'numeric',
                    hour: '2-digit',
                ...
                const details = `
                        ...
                        <h2>${json.data.name} <small>(SKU: ${json.data.sku})</small></h2>
                        <table>
                            <tbody>
                                <tr>
                                    <th>ID</th>
